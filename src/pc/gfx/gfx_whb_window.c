...
static void gfx_whb_window_set_fullscreen_changed_callback(UNUSED void (*on_fullscreen_changed)(bool is_now_fullscreen)) {
}

static void gfx_whb_window_set_fullscreen(UNUSED bool enable) {
}
